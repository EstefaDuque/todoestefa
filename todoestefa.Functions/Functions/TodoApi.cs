...
using todoestefa.Common.Models;
using todoestefa.Common.Responses;

namespace todoestefa.Functions.Entities.Functions
{
    public static class TodoApi
    {
            ...
            ILogger log)
        {
            ...
            string message = $"Todo: {id}, updated in tabele";
            log.LogInformation(message);
        ...
        public static IActionResult GetAllTodoById(
             ...
             string id,
              ILogger log)
        {
            log.LogInformation($"Get todo by id : {id}");
